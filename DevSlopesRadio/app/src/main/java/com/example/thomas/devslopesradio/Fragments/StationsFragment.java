package com.example.thomas.devslopesradio.Fragments;
...
import com.example.thomas.devslopesradio.Adaptors.StationsAdaptor;
import com.example.thomas.devslopesradio.R;
import com.example.thomas.devslopesradio.Services.DataService;
...
public class StationsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.recyclerSations);
        recyclerView.setHasFixedSize(true);

        StationsAdaptor adaptor;
        if(stationType == STATION_TYPE_FEATURED){
            adaptor = new StationsAdaptor(DataService.getInstance().getFeaturedStations());
        }
