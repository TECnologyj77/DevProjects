...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentManager.beginTransaction().add(R.id.containerTopRow,stationsFragment1).commit();
        stationsFragment2 = StationsFragment.newInstance(StationsFragment.STATION_TYPE_RECENT);
        fragmentManager.beginTransaction().add(R.id.containerMiddleRow,stationsFragment2).commit();
        stationsFragment3 = StationsFragment.newInstance(StationsFragment.STATION_TYPE_PARTY);
        fragmentManager.beginTransaction().add(R.id.containerBottomRow,stationsFragment3).commit();
